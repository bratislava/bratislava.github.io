...
<Callout emoji="🙏️">
  Regardless of the editor you use, you should always **format and lint** your code **on save**, or
  at least before committing. Formatting and linting should be performed by **locally installed
  Prettier and ESlint** to prevent inconsistencies.
</Callout>
...
<Callout emoji="⚠️" type="warning">
  Other combination of checked options may lead to inconsistencies. I also added `json` to be
