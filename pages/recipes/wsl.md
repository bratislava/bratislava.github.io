...
After this you should be able to log into our kubernetes cluster. You can test and login in by following our [Login guide](./kubernetes-lens-setup).
...
To login to our cluster you can follow our [Login guide](./kubernetes-lens-setup).
