...
For guide on loading dumps like this locally (i.e. for Strapi CMS) see [the appropriate recipe](../recipes/database-manipulation/load-strapi-db-in-local-dev.md).
